#######################################################################################################################
### A Decent DE1 app plugin that provides a skin-independent, themable, page-oriented GUI "framework".
###
### https://github.com/ebengoechea/de1app_plugin_DGUI
### This code is released under GPLv3 license. 
#######################################################################################################################

set plugin_name "DGUI"
...
proc ::plugins::DGUI::IS::show_page {} {
	...
	if { [llength $data(item_values)] == 0 } {
		...
		#show_widgets $widgets(empty_items_msg) $ns
		#return
	}
